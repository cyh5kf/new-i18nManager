...
public class ReflectUtils {
    ...
    public static <T> Field getObjectFieldByName(Collection<T> collections, String fieldName) throws Exception {
    ...
    public static <T> Field getObjectFieldByName(Class<?> clazz, String fieldName) throws Exception {

        Map<String, Field> fields = ReflectUtils.getMappedObjectFields(clazz);
        Field field = fields.get(fieldName);
        if (field == null) {
            throw new MessageException(fieldName);
        }
        return field;
    ...
    public static Object getFieldValue(Object instance, String fieldName) throws Exception {
        Field field = getObjectFieldByName(instance.getClass(),fieldName);
        return field.get(instance);
    }



    public static void setFieldValue(Object instance, String fieldName, String value) throws Exception {
        Field field = getObjectFieldByName(instance.getClass(),fieldName);
